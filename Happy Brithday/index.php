<html __fvdsurfcanyoninserted="1" class="
...
<head>
    ...
    <title>Happy Birthday Hải ú</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="avatar">
            ...
            <img src="./278456603_1021070378810480_4871237907736860424_n.jpg" alt="" class="avatar__img" onclick="showMessage()" />
            <!-- 4. Tên của người đó -->
            <h1 onclick="showMessage()" class="avatar__title">Ngô Thế Hải</h1>
        </div>
    ...
    <script>
        ...
        function showMessage() {
            ...
            swal({
                ...
                text: "Một ngày đặc biệt đúng không? Chúc bạn tuổi mới mạnh khỏe, học giỏi, kiếm được nhiều tiền để dẫn mình đi chơi và đặc biệt mau mau có người yêu để ra mắt bạn bè nha. ", // Nội dung lời nhắn
                button: {
                    text: "👌",
                },
            });
